 ...
 * 
 * @see team.jmu.bean.TSeller
 * @author MyEclipse Persistence Tools
 */
public class TSellerDAO extends HibernateDaoSupport {
	private static final Logger log = LoggerFactory.getLogger(TSellerDAO.class);
	...
	public List findByExample(TSeller instance) {
	...
	public TSeller merge(TSeller detachedInstance) {
		...
		try {
			TSeller result = (TSeller) getHibernateTemplate().merge(
					detachedInstance);
	...
	public static TSellerDAO getFromApplicationContext(ApplicationContext ctx) {
		return (TSellerDAO) ctx.getBean("TSellerDAO");
	}
}